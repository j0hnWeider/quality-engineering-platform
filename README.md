...
Instruções para corrigir o README no GitHub
Abra o arquivo README.md no seu repositório local (no VS Code, bloco de notas, etc.).

Selecione todo o conteúdo atual e substitua pelo código acima.

Salve o arquivo.

No terminal, adicione, comite e envie:
